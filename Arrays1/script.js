...
// Filter inventors who were born between 1500 and 1600
const inventorsBornBetween1500And1600 = inventors.filter(
  (inventor) => inventor.year >= 1500 && inventor.year < 1600
);

// Get the full names of all the inventors
const inventorFullNames = inventors.map(
  (inventor) => `${inventor.first} ${inventor.last}`
);

// Sort the inventors by birth year
const inventorsSortedByBirthYear = inventors.sort((a, b) =>
  a.year > b.year ? 1 : -1
);

// Calculate the total number of years that all the inventors lived
const totalYearsLivedByInventors = inventors.reduce(
...
// Sort an array of people by last name
